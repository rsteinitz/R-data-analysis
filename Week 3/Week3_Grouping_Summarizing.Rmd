...
Now that we can filter and select data, we’ll learn how to summarize it by group.
Think of this as splitting data into smaller pieces (groups), calculating statistics within each, and then combining the results.  
